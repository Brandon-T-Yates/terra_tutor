...
class ThemeNotifier extends ChangeNotifier {
  ...
  static final ThemeData defaultTheme = ThemeData(
    ...
    cardColor: AppColors.menuIconHighLight, // Needs to stay menuIconHighLight variable
  ...
  static final ThemeData highDesertTheme = ThemeData(
    ...
    appBarTheme: const AppBarTheme(
      ...
      iconTheme:
          IconThemeData(color: AppColorsAlternativeHighDesert.menuIconClicked),
    ),
    buttonTheme: const ButtonThemeData(
    ...
    textTheme: const TextTheme(
      ...
      headlineLarge: TextStyle(color: AppColorsAlternativeHighDesert.fontColor),
    ),
  ...
  static final ThemeData redwoodForestTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      bodyLarge: TextStyle(color: AppColorsAlternativeRedwoodForest.fontColor),
      headlineLarge:
